...
PY_FILES = weibullanalyse.py ui_weibullanalyse.py weibullanalysedialog.py __init__.py
...
test: compile transcompile
	...
	@-export PYTHONPATH=`pwd`:$(PYTHONPATH); \
		...
		nosetests3 -v --with-id --with-coverage --cover-package=. \
		3>&1 1>&2 2>&3 3>&- || true
	@echo "----------------------"
...
deploy: compile doc transcompile
	@echo
	@echo "------------------------------------------"
	@echo "Deploying plugin to your $(HOME)/$(QGISDIR) directory."
	@echo "------------------------------------------"
